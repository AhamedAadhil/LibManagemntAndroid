...
public class AdminAddUsersActivity extends AppCompatActivity {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(imagepath!=null){
                            ...
                            if(task.isSuccessful()){
                                ...
                                uploader.putFile(imagepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                            ...
                                            public void onSuccess(Uri uri) {
                                                ...
                                                root.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        Toast.makeText(AdminAddUsersActivity.this, "User Registered Successfully", Toast.LENGTH_SHORT).show();
                                                        startActivity(new Intent(AdminAddUsersActivity.this,AdminDashboardActivity.class));
                                                        finish();
                                                    }
                                                });
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(AdminAddUsersActivity.this, "Registration fail", Toast.LENGTH_SHORT).show();
                                        spinKitView.setVisibility(View.GONE);
                                    }
                                });
                            }
                            else{
                                Toast.makeText(AdminAddUsersActivity.this, "Email already Exist", Toast.LENGTH_SHORT).show();
                                spinKitView.setVisibility(View.GONE);
                            }
                        }
                    });
                    ...
                    Toast.makeText(AdminAddUsersActivity.this, "Please select any image", Toast.LENGTH_SHORT).show();
                }
    ...
    private void requestPermisson() {
        ...
        if(ContextCompat.checkSelfPermission(AdminAddUsersActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                == PackageManager.PERMISSION_GRANTED){
            selectImage();
        }else{
            ActivityCompat.requestPermissions(AdminAddUsersActivity.this, new String[]{
    ...
    public void onBackPressed () {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(AdminAddUsersActivity.this);
